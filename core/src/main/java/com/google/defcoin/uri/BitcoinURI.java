 ...
 *
 * <ul>
 * <li>{@code defcoin:<address>}</li>
 * <li>{@code defcoin:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
...
public class BitcoinURI {
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        // URI is formed as  defcoin:<address>?<query parameters>
        // blockchain.info generates URIs of non-BIP compliant form defcoin://address?....
        // We support both until Ben fixes his code.
        
        // Remove the defcoin scheme.
        // (Note: getSchemeSpecificPart() is not used as it unescapes the label and parse then fails.
        // For instance with : defcoin:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
