...
package com.google.defcoin.store;
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.defcoin.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.defcoin.core.BlockChain#getBestChainHeight()} which will run in constant time and
