...
package com.google.defcoin.core;

import com.google.defcoin.core.TransactionConfidence.ConfidenceType;
import com.google.defcoin.crypto.KeyCrypter;
import com.google.defcoin.crypto.KeyCrypterException;
import com.google.defcoin.crypto.KeyCrypterScrypt;
import com.google.defcoin.script.Script;
import com.google.defcoin.script.ScriptBuilder;
import com.google.defcoin.script.ScriptChunk;
import com.google.defcoin.store.UnreadableWalletException;
import com.google.defcoin.store.WalletProtobufSerializer;
import com.google.defcoin.utils.ListenerRegistration;
import com.google.defcoin.utils.Threading;
import com.google.defcoin.wallet.*;
import com.google.defcoin.wallet.WalletTransaction.Pool;
...
import static com.google.defcoin.core.Utils.bitcoinValueToFriendlyString;
import static com.google.defcoin.core.Utils.bitcoinValueToPlainString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.defcoin.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.defcoin.core.Wallet#getBalance()} - the fees required
         ...
         *
         * <p>Once {@link Wallet#completeTx(com.google.defcoin.core.Wallet.SendRequest)} is called, this is set to the
        ...
        /**
         * If not null, the {@link com.google.defcoin.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
...
//                            throw new IllegalArgumentException("Tried to send dust with ensureMinRequiredFee set - no way to complete this");
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.defcoin.wallet.WalletFiles.Listener)}
     ...
     * of {@link com.google.defcoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.defcoin.crypto.KeyCrypter,
     ...
     * {@link com.google.defcoin.crypto.KeyCrypterScrypt}.
     *
        ...
        try {
            ...
            for (ECKey key : keychain) {
                if (key.isEncrypted()) {
                    ...
                    // (all defcoin controlled by that private key is lost forever).
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.defcoin.crypto.KeyCrypter,
     ...
     * you can use {@link com.google.defcoin.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.defcoin.core.TransactionBroadcaster broadcaster) {
