...
import com.google.defcoin.crypto.TransactionSignature;
import com.google.defcoin.script.Script;
import com.google.defcoin.script.ScriptBuilder;
import com.google.defcoin.script.ScriptOpCodes;
...
import static com.google.defcoin.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable {
     ...
     */
    public static final BigInteger REFERENCE_DEFAULT_MIN_TX_FEE = BigInteger.valueOf(0); // 1 Doge minimum fee!
     ...
     */
    public static final BigInteger MIN_NONDUST_OUTPUT = BigInteger.ZERO; //DOGE: We can send one "shibetoshi" but this will cost us extra fee!

    // These are serialized in both defcoin and java serialization.
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.defcoin.script.Script, ECKey, com.google.defcoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.defcoin.core.Transaction.SigHash, boolean)}
    ...
    public synchronized Sha256Hash hashForSignature(int inputIndex, byte[] connectedScript, byte sigHashType) {
        ...
        //
        //   https://en.defcoin.it/wiki/Contracts
