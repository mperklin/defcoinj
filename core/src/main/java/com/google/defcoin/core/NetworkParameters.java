...
import com.google.defcoin.params.*;
...
import static com.google.defcoin.core.Utils.COIN;
...
public abstract class NetworkParameters implements Serializable {
    ...
    public static final String ID_TESTNET = "org.defcoin.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.defcoin.unittest";
    ...
    public static final int TARGET_TIMESPAN = (int)(2 * 24 * 60 * 60);  // 2d per difficulty cycle, on average.
    ...
    /**
     * First byte of a base58 encoded address. See {@link com.google.defcoin.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link com.google.defcoin.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link com.google.defcoin.core.AlertMessage}s. You can use {@link com.google.defcoin.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
