...
public abstract class Message implements Serializable {
    ...
    /**
     * Serialize this message to a byte array that conforms to the defcoin wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the defcoin wire format.
     *
     * @param stream
     * @throws IOException
     */
