...
import com.google.defcoin.net.ClientConnectionManager;
import com.google.defcoin.net.NioClientManager;
import com.google.defcoin.net.discovery.PeerDiscovery;
import com.google.defcoin.net.discovery.PeerDiscoveryException;
import com.google.defcoin.params.MainNetParams;
import com.google.defcoin.script.Script;
import com.google.defcoin.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link com.google.defcoin.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.google.defcoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.defcoin.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.google.defcoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.defcoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.defcoin.core.Peer#ping()}.
     */
